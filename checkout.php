...
<?php include_once('includes/navbar.php');?>    
    ...
    <div class="container wrapper">
        <div class="row cart-head">
            ...
            <!--        <span class="step step_complete"> <a href="addtocart.php" class="check-bc">Cart</a> <span class="step_line step_complete"> </span> <span class="step_line backline"> </span> </span>-->
        ...
        <div class="row cart-body">
            <form class="form-horizontal" method="post" action="checkout_action.php">
            ...
            <?php
                          $Rent=0;
                       $sql1 = "select c.*,p.* from tbl_cart c INNER JOIN tbl_product p on c.pro_id = p.id where `user_id`='".$_SESSION['id']."' AND cart_status=3 ";
           
                       foreach ($con->query($sql1) as $row1) {
                        
                       $ct_id=$row1['cart_id'];
                       $carts_id=explode(",",$ct_id);
                       $total_amount +=$row['cart_amount'];
                        }?>
                        
                        <?php
                            foreach($carts_id as $value)
                                {
                                    echo '<input type="hidden" name="cart_id[]" value="'. $value. '">';
                                }

                            ?>
                        
                        <input type="hidden" name="rent_amount" value="<?php echo $total_amount;?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <input type="text" name="first_name" class="form-control" value="<?php echo $customer_name?>" required />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12"><input type="text" name="phone_number" class="form-control" value="<?php echo $customer_phone;?>" /></div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-12"><strong>Email Address:</strong></div>
                            <div class="col-md-12"><input type="text" name="email_address" class="form-control" value="<?php echo $customer_email;?>" /></div>
                        </div>
                        
                        
                            <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <button type="submit" name="place_pay" class="btn btn-primary">process to pay</button>
                             <!--   <script-->
                            	...
                            	<!--	data-currency="USD"-->
                            	<!--	data-email="ArtDecals.co.uk@yahoo.com"-->
                            	<!-->-->
                            	<!--</script>-->
                            </div>
